...
static RPCHelpMan getblockheader()
{
    return RPCHelpMan{"getblockheader",
                ...
                },
                {
                    ...
                    {RPCResult::Type::NUM, "header_version", "The block header format version (2 for BLAKE2b headers, 0 otherwise)"},
                            {RPCResult::Type::NUM, "header_version", "The block header format version (2 for BLAKE2b headers, 0 otherwise)"},
                    ...
                    {RPCResult::Type::NUM, "nonce2", /*optional=*/true, "The second nonce (header version 2 only)"},
                    {RPCResult::Type::NUM, "nonce3", /*optional=*/true, "The third nonce (header version 2 only)"},
                    {RPCResult::Type::STR_HEX, "extranonce", /*optional=*/true, "The extranonce (header version 2 only)"},
                    {RPCResult::Type::NUM, "h1_flags", /*optional=*/true, "The header 1 flags (header version 2 only)"},
                    {RPCResult::Type::STR_HEX, "xor_key", /*optional=*/true, "The proof-of-work XOR key (header version 2 only)"},
                    {RPCResult::Type::NUM, "xor_key_mask_clear_bits", /*optional=*/true, "Number of leading XOR mask bits cleared (header version 2 only)"},
                            {RPCResult::Type::NUM, "nonce2", /*optional=*/true, "The second nonce (header version 2 only)"},
                            {RPCResult::Type::NUM, "nonce3", /*optional=*/true, "The third nonce (header version 2 only)"},
                            {RPCResult::Type::STR_HEX, "extranonce", /*optional=*/true, "The extranonce (header version 2 only)"},
                            {RPCResult::Type::NUM, "h1_flags", /*optional=*/true, "The header 1 flags (header version 2 only)"},
