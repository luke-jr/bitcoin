...
public:
    ...
    [[nodiscard]] uint64_t GetPruneTargetForChainstate(const Chainstate& chain, ChainstateManager& chainman, uint64_t current_disk_usage) const EXCLUSIVE_LOCKS_REQUIRED(cs_main);
